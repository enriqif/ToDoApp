...
import com.widoo.todoapp.data.PreferencesManager
import com.widoo.todoapp.data.SortOrder
import com.widoo.todoapp.data.TaskDao
import com.widoo.todoapp.data.Task
import com.widoo.todoapp.ui.ADD_TASK_RESULT_OK
import com.widoo.todoapp.ui.EDIT_TASK_RESULT_OK
...
class TaskViewModel @ViewModelInject constructor(
    ...
    private val taskFlow = combine(
        ...
        taskDao.getTask(
            query, preferencesFlow.sortOrder, preferencesFlow.hideCompleted
        )
    }
